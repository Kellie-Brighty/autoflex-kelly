...
import AgentTransactionStatusChipComponent from "@/components/agent/transactions/status-chip";
    ...
    setTransactionsRows([
      {
        ...
        data: {
          ...
          6: <AgentTransactionStatusChipComponent type={"success"} />,
          7: (
      ...
      },
      {
        ...
        data: {
          ...
          4: <span>₦625,000</span>,
          5: <span>01.01.2022</span>,
          6: <AgentTransactionStatusChipComponent type={"pending"} />,
          7: (
            <ButtonComponent size={"sm"} variant={"outlined"}>
              <span>View Details</span>
            </ButtonComponent>
      ...
      },
      {
        ...
        data: {
          ...
          4: <span>₦625,000</span>,
          5: <span>01.01.2022</span>,
          6: <AgentTransactionStatusChipComponent type={"failed"} />,
          7: (
            <ButtonComponent size={"sm"} variant={"outlined"}>
              <span>View Details</span>
            </ButtonComponent>
