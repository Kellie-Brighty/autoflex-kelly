...
interface AgentPolicyStatsCardComponentProps {
  type: "total" | "active" | "pending" | "expired";
  value: number;
  change: number;
}

const agentPolicyStatsCardTypeMap = {
...
const AgentPolicyStatsCardComponent: React.FC<
  AgentPolicyStatsCardComponentProps
> = ({ type, value, change }) => {
  return (
    <div className={"p-6 flex items-center gap-3 bg-white rounded-md"}>
      ...
      <div className={"flex flex-col"}>
        <span className={"text-gray-dark font-medium"}>
          {agentPolicyStatsCardTypeMap[type]}
        </span>
...
export default AgentPolicyStatsCardComponent;
