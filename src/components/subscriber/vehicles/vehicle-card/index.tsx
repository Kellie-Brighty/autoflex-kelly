...
interface SubscriberVehicleCardComponent {
  carName: string;
  plateNumber: string;
...
const SubscriberVehicleCardComponent: React.FC<
  SubscriberVehicleCardComponent
> = ({ carName, plateNumber, registrationName, color, premium }) => {
  return (
    <div
      className={
...
export default SubscriberVehicleCardComponent;
